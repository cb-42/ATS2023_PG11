...
Optional: See Supplemental (9.1.1) for several strategies for creating stacked bar charts to compare OTU relative abundances.  

### 4.1.3 Trees and heat maps  
Optional: See Supplemental (9.1.2) for two approaches of constructing heap maps using lung specimens to compare OTU relative abundances.  
...
### 9.1.1 Relative Abundance  

#### 9.1.1.a Stacked Bar examples  
...
#### 9.1.2.b Base R implementation & dendrogram  
...
#### 9.1.3.a Regression  
With a few minor tweaks to the code for data preparation, retrieval, and plotting, we'll demonstrate how to retrieve feature importances from a collection of random forest regression models.  
