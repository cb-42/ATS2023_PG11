...
ggplot(bc_tissue_vend_df, aes(x = vendor, y = Mean_BC, fill = vendor)) + 
  ...
  geom_point(size=1, alpha=0.5, position = position_jitter(width = 0.175, seed = 8237)) + #adjust  # add 'noisy' points for specimens (adjust width to improve visibility on discrete x-axis)
  theme_bw() + # A minimalist theme
